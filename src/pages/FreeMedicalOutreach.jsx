...
const galleryImages = ['/2024/09/21.jpg', '/2024/08/medical_camp.jpg']
...
const FreeMedicalOutreach = () => {
  return (
    <div className="outreach-detail">
      <section className="detail-hero detail-hero--medical">
        <div className="detail-hero__bg" />
        <div className="detail-hero__overlay" />
        <div className="container detail-hero__content">
          <Reveal>
            <span className="eyebrow">FREE MEDICAL OUTREACHES</span>
            <h1>FREE MEDICAL OUTREACHES</h1>
          </Reveal>
        </div>
      </section>
          ...
          <Reveal>
            <section className="detail-split surface-card">
              <div className="detail-copy">
                <h2>FREE MEDICAL OUTREACHES</h2>
                <blockquote>‘…this is especially to children.’</blockquote>
                <p>There have been camps where we would provide free medical care for up to 1400 Children.</p>
...
export default FreeMedicalOutreach
